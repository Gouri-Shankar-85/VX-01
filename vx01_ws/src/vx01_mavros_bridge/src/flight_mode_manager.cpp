...
FlightModeManager::FlightModeManager(rclcpp::Node::SharedPtr node)
    ...
    RCLCPP_INFO(node_->get_logger(), "FlightModeManager initialized");
}
...
bool FlightModeManager::isConnected() const { return is_connected_; }
bool FlightModeManager::isArmed() const { return is_armed_; }
FlightMode FlightModeManager::getCurrentMode() const { return current_mode_; }
